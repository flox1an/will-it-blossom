...
async function loadManifests(artifactsDir) {
    try {
...
async function renderRun(artifactsDir, outDir, manifest) {
    ...
    for (const t of manifest.targets) {
        ...
        try {
            ...
            const res = JSON.parse(resultsContent);
            // Render target page
...
async function buildSite() {
    ...
    // Write CSS
    await writeFile(join(outDir, 'assets', 'style.css'), `
